...
class Repository(private val sharedPrefs: SharedPreferences, database: Database) {
    ...
    fun getMessageSortAscending(): Boolean {
        return sharedPrefs.getBoolean(SHARED_PREFS_MESSAGE_SORT_ASCENDING, false)
    }

    fun setMessageSortAscending(ascending: Boolean) {
        sharedPrefs.edit {
            putBoolean(SHARED_PREFS_MESSAGE_SORT_ASCENDING, ascending)
        }
    }
    ...
    companion object {
        ...
        const val SHARED_PREFS_MESSAGE_SORT_ASCENDING = "MessageSortAscending"
